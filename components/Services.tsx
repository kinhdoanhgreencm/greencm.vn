      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          {SERVICES.map((service) => (
            <div 
              key={service.id} 
              className="group relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 h-[450px] flex flex-col"
            >
              {/* Image Container */}
              ...
              <div className="h-1/2 p-6 bg-black text-white flex flex-col justify-between relative">
                ...
                <button className="self-start mt-4 text-sm font-semibold text-white border-b border-gcm-green pb-1 hover:text-gcm-green transition-colors">
                  Tìm hiểu thêm &rarr;
                </button>
              </div>
            </div>
