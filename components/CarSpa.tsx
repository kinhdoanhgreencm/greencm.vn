      ...
      <section className="relative h-[600px] w-full flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            GCM Auto Spa<br/>
            <span className="text-gray-300">Đánh Thức Vẻ Đẹp Nguyên Bản</span>
          </h1>
          <p className="text-gray-200 text-lg md:text-xl max-w-2xl mx-auto mb-10 font-light">
            Quy trình chuẩn Quốc tế • An toàn tuyệt đối cho xe điện • Hóa chất phân hủy sinh học
          </p>
          <button 
      ...
      <section className="py-20 bg-black text-white overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <img 
              src={imageErrors['after'] ? getFallbackImage() : "https://images.unsplash.com/photo-1605218427306-022ba8c6c54f?auto=format&fit=crop&q=80"} 
            ...
            >
              <img 
                src={imageErrors['before'] ? getFallbackImage() : "https://images.unsplash.com/photo-1617627402099-0b1a0e8d0d61?auto=format&fit=crop&q=80"} 
