...
const UsedCarExchange: React.FC = () => {
  ...
  return (
    <div className="pt-20 bg-gray-50 min-h-screen">
      ...
      {/* 1. Hero Section & Smart Filter */}
      <section className="relative h-[500px] md:h-[600px] w-full flex flex-col items-center justify-center overflow-hidden">
        {/* Background */}
        <div 
        ...
        <div className="relative z-10 container mx-auto px-4 text-center mt-[-50px]">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-2 leading-tight">
            Sàn Giao Dịch Xe Ô Tô Điện Cũ Uy Tín
          </h1>
          <p className="text-gcm-green font-medium text-lg md:text-xl mb-8 flex items-center justify-center gap-2">
            <CheckCircle size={20} /> Kiểm Định Pin Minh Bạch
          </p>

          {/* Smart Filter Box */}
          <div className="bg-white p-4 md:p-6 rounded-2xl shadow-2xl max-w-5xl mx-auto w-full">
