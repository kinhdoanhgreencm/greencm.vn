    ...
    <div className="pt-20">
      ...
      <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: 'url("https://images.unsplash.com/photo-1617788138017-80ad40651399?auto=format&fit=crop&q=80")', // Electric car charging/modern vibe
          }}
          role="img"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
            GCM – All About Cars<br/>
            <span className="text-gcm-green">Tiên Phong Kiến Tạo Hệ Sinh Thái Ô Tô Điện Toàn Diện</span>
          </h1>
          <h2 className="text-lg md:text-2xl text-gray-200 font-light max-w-4xl mx-auto">
            Giải pháp trọn gói cho mọi nhu cầu xe điện của bạn – Từ Mua bán, Cho thuê đến Chăm sóc & Bảo dưỡng.
          </h2>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-white p-10 rounded-3xl shadow-lg border-l-8 border-gcm-green flex flex-col justify-center">
              <div className="w-16 h-16 bg-gcm-green/10 rounded-full flex items-center justify-center mb-6 text-gcm-green">
                <Target size={32} />
              </div>
              <h3 className="text-2xl font-bold text-gcm-dark mb-4">Tầm Nhìn</h3>
            ...
            <div className="bg-white p-10 rounded-3xl shadow-lg border-l-8 border-black flex flex-col justify-center">
               <div className="w-16 h-16 bg-black/5 rounded-full flex items-center justify-center mb-6 text-black">
                <Users size={32} />
              </div>
              <h3 className="text-2xl font-bold text-gcm-dark mb-4">Sứ Mệnh</h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl border border-gray-100 hover:border-gcm-green hover:shadow-xl transition-all group">
              <div className="w-12 h-12 bg-gcm-green/10 rounded-xl flex items-center justify-center text-gcm-green mb-6 group-hover:bg-gcm-green group-hover:text-white transition-colors">
                <ShoppingBag />
              </div>
              <h3 className="text-xl font-bold mb-3">Mua Bán Xe Điện Mới</h3>
            ...
            <div className="p-8 rounded-2xl border border-gray-100 hover:border-gcm-green hover:shadow-xl transition-all group">
              ...
              <h3 className="text-xl font-bold mb-3">Sàn Giao Dịch Xe Cũ</h3>
            ...
            <div className="p-8 rounded-2xl border border-gray-100 hover:border-gcm-green hover:shadow-xl transition-all group">
              ...
              <h3 className="text-xl font-bold mb-3">Dịch Vụ Cho Thuê Xe</h3>
            ...
            <div className="p-8 rounded-2xl border border-gray-100 hover:border-gcm-green hover:shadow-xl transition-all group">
              ...
              <h3 className="text-xl font-bold mb-3">Phụ Kiện & Đồ Chơi Xe</h3>
            ...
            <div className="p-8 rounded-2xl border border-gray-100 hover:border-gcm-green hover:shadow-xl transition-all group">
              ...
              <h3 className="text-xl font-bold mb-3">Hỗ Trợ Đăng Kiểm</h3>
            ...
            <div className="p-8 rounded-2xl border border-gray-100 hover:border-gcm-green hover:shadow-xl transition-all group">
              ...
              <h3 className="text-xl font-bold mb-3">Vệ Sinh & Detailing</h3>
