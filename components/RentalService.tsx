...
const RentalService: React.FC = () => {
  ...
  return (
    <div className="pt-20 bg-gray-50 min-h-screen">
      {/* 1. Hero Section & Quick Booking */}
      <section className="relative h-[600px] w-full flex flex-col items-center justify-center overflow-hidden">
        {/* Background */}
        <div 
          className="absolute inset-0 bg-cover bg-center z-0"
          style={{ 
            backgroundImage: 'url("https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&q=80")', // Family trip driving vibe
          }}
          role="img"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-gray-200 font-medium text-lg mb-8 max-w-2xl mx-auto">
            Tự lái • Có tài xế • Xe hoa • Xe sự kiện | Thủ tục 5 phút – Giao xe tận nơi.
          </p>

          {/* Quick Booking Widget */}
          <div className="bg-white p-4 md:p-6 rounded-2xl shadow-2xl max-w-5xl mx-auto w-full flex flex-col md:flex-row gap-4 items-end">
      ...
      <section className="py-16 container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all border border-gray-100 group">
            ...
            <h3 className="text-xl font-bold mb-2">Cho Thuê Xe Tự Lái</h3>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all border border-gray-100 group">
            ...
            <h3 className="text-xl font-bold mb-2">Thuê Xe Có Tài Xế</h3>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all border border-gray-100 group">
            <div className="w-14 h-14 bg-pink-50 text-pink-500 rounded-full flex items-center justify-center mb-4 group-hover:bg-pink-500 group-hover:text-white transition-colors">
              <Heart size={28} />
            </div>
            <h3 className="text-xl font-bold mb-2">Xe Hoa & Đám Cưới</h3>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all border border-gray-100 group">
            ...
            <h3 className="text-xl font-bold mb-2">Xe Sự Kiện & Doanh Nghiệp</h3>
