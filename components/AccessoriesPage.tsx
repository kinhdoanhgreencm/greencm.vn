    ...
    <div className="pt-20 bg-gray-50 min-h-screen">
      ...
      <section className="relative h-[600px] w-full flex flex-col items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1621251314352-78d1222449c7?auto=format&fit=crop&q=80")' }}
          role="img"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center mt-[-40px]">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4 leading-tight">
            Nâng Tầm Tiện Ích – Cá Nhân Hóa Xế Điện Của Bạn
          </h1>
          <p className="text-gray-200 text-lg mb-10 max-w-2xl mx-auto">
            Hàng nghìn phụ kiện chính hãng, tương thích hoàn hảo, bảo hành điện tử 1 đổi 1.
          </p>

          {/* Smart Filter Widget */}
          <div className="bg-white p-6 md:p-8 rounded-3xl shadow-2xl max-w-4xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((cat) => (
            <div key={cat.id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-gcm-green transition-all group cursor-pointer">
              <div className={`w-16 h-16 ${cat.color} rounded-2xl flex items-center justify-center mb-6 transition-transform group-hover:scale-110`}>
                {cat.icon}
              </div>
              <h3 className="text-xl font-bold mb-2 group-hover:text-gcm-green transition-colors">{cat.title}</h3>
             ...
             <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:border-gcm-green transition-all group">
                <div className="flex gap-4 mb-6">
                   <div className="w-24 h-24 bg-gray-800 rounded-lg overflow-hidden">
                      <img 
                        src="https://images.unsplash.com/photo-1621251314352-78d1222449c7?auto=format&fit=crop&q=80" 
